...
SKELETON_NETWORK_STATIC_IFACE = $(call qstrip,$(BR2_SYSTEM_NETWORK_CONFIG_STATIC_NAME))

ifneq ($(SKELETON_NETWORK_STATIC_IFACE),)
define SKELETON_SET_NETWORK_STATIC
	( \
		echo ;								\
		echo "auto $(SKELETON_NETWORK_STATIC_IFACE)";			\
		echo "iface $(SKELETON_NETWORK_STATIC_IFACE) inet static";	\
